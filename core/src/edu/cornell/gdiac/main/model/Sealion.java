...
public class Sealion extends PolygonObstacle {
     ...
     */
    public Sealion(JsonValue data, float x, float y, float width, float height, String name, float range) {
        super(new float[] {-width/2*0.25f,height/2*0.25f,-width/2*0.25f,-height/2*0.25f,width/2*0.25f,-height/2*0.25f,-width/2*0.25f+0.5f,height/2*0.25f},x,y+0.7f);
