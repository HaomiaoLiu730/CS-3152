...
public class Ice extends CapsuleObstacle {
    // Physics constants
     ...
     */
    public Ice(float width, float height, String name) {
     ...
     * @param height	The object width in physics units
     */
    public Ice(float x, float y, float width, float height, String name) {
